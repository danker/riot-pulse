...
class MarkdownFormatter:
    ...
    def create_report(self, results: Dict[RiotGames, Dict[AnalysisAspects, str]], 
                     filename: str, config: ReportConfig) -> None:
        """
        ...
        content = self._generate_markdown_content(processed_results, timestamp, filename, config)
        
        # Write to file
        with open(filename, 'w', encoding='utf-8') as f:
            f.write(content)
    
    def _generate_markdown_content(self, results: Dict[RiotGames, Dict[AnalysisAspects, str]], 
                                  timestamp: str, filename: str, config: ReportConfig) -> str:
